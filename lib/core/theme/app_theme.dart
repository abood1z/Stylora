...
class AppTheme {
  ...
  static const primaryColor = Color(
    0xFFD4AF37,
  ); // ذهبي ملكي ناعم (Royal Gold) 0xFFD4AF37
  static const secondaryColor = Color(
    0xFF1F1B15,
  ); // بني أونيكس عميق (Onyx Brown)
  ...
  // 🚀 إعدادات تصميم الأزرار الموحدة لكامل التطبيق (لتسهيل التعديل والصيانة لاحقاً)
  static const double buttonRadius =
      24.0; // انحناء زوايا الأزرار الموحد لجعلها دائرية وناعمة (Pill-shaped)
  static const double buttonHeight =
      48.0; // الارتفاع الموحد للأزرار الأساسية في التطبيق (Slim & Sleek)
  ...
  static ThemeData _buildTheme(Brightness brightness) {
    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style:
            ElevatedButton.styleFrom(
              ...
              // 📐 تطبيق الارتفاع الموحد والزوايا الدائرية الموحدة على أزرار التطبيق
      ...
      cardTheme: CardThemeData(
        elevation: 0,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(24), // انحناء زوايا البطاقات
          side: BorderSide(
            color: isDark
